...
globals.set("MAVEN_SETTINGS_FILE_HOST_PATH",
  "${globals.get('JENKINS_PARENT_WORKSPACE_HOST_PATH')}/tools-data/maven/config/settings.xml")
...
globals.set("MAVEN_SEC_SETTINGS_FILE_HOST_PATH",
  "${globals.get('JENKINS_PARENT_WORKSPACE_HOST_PATH')}/tools-data/maven/config/settings-security.xml")
